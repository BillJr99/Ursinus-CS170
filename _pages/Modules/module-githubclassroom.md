...
1. **Accept** the assignment invitation link (once per assignment).
2. **Clone** your new repository to your computer: `git clone <your repository url>`.
3. **Work** on the assignment, and `git add`, `git commit`, and `git push` early and often as you make progress.
4. **Check on github.com** before the deadline that your latest work is visible in your repository — including your `README.md` writeup.  What you see on the website is exactly what will be graded!
