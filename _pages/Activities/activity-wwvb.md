...
<p align="center">
<img style="max-width:100%;" alt="A marker followed by two zero bits from WWVB using PWM" src="../../images/activity-wwvb/marker-zero-zero.png">
</p>

Here's another example that sends a zero, a one, and a one bit.

<p align="center">
<img style="max-width:100%;" alt="A zero followed by two one bits from WWVB using PWM" src="../../images/activity-wwvb/zero-one-one.png">
</p>
